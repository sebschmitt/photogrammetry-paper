...
In~\cite{hassaballah_2016} wird \emph{Feature Matching} als das Bilden von Korrespondenzen zwischen zwei Bildern der gleichen Szene bzw.\ Objekts beschrieben.
